...
public class AuthUtil {
  ...
  public static AuthorizationCodeFlow newAuthorizationCodeFlow() throws IOException {
    ...
    String resource = "/oauth.properties";
    File propertiesFile = new File("./src/main/resources/oauth.properties");
    propFileInputStream = AuthUtil.class.getResourceAsStream(resource);

    if(propFileInputStream == null) {
        propFileInputStream = new FileInputStream(propertiesFile);
    }
    Properties authProperties = new Properties();
    authProperties.load(propFileInputStream);
